...
function simple_beams_enqueue_scripts() {
    ...
    // Enqueue external libraries from CDN
    wp_enqueue_script('chart-js-cdn', 'https://cdn.jsdelivr.net/npm/chart.js', array(), null, true);
    wp_enqueue_script('mathjax-cdn', 'https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js', array(), null, true);
}
    ...
    <div class="container">
      <div class="column">
        ...
        <div class="input-group">
          ...
          <input type="number" class="input-field" placeholder="" id="input1">
          <span class="unit" id="dynamicUnit"></span>
        </div>
        <div class="input-group">
          <span class="label">L = </span>
          <input type="number" class="input-field" placeholder="" id="input2">
          <span class="unit" id="beamLengthUnit"></span>
        </div>
        <div class="input-group">
          <span class="label">J = </span>
          <input type="number" class="input-field" placeholder="" id="input3">
          <span class="unit" id="inertiaUnit"></span>
        </div>
        <div class="input-group">
          <span class="label">E = </span>
          <input type="number" class="input-field" placeholder="" id="input4">
